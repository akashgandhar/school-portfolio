...
export default function Footer() {
  return (
    <footer>
      <div class="bg-[#255c39] py-4 text-white">
        <div class="container px-4 mx-auto">
          <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4 my-4 w-full xl:w-1/3">
              <Link
                href="/"
                class=" mb-10 flex items-center gap-3 text-xl whitespace-normal break-words"
              >
                <img
                  src="/logo.png"
                  alt="Tailwindow"
            ...
            <div class="px-4 my-4 w-full sm:w-auto">
              <div>
                <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-[#83cb9d]">
                  Founders
                </h2>
              </div>
              <ul class="leading-8">
                <li>
                  <Link href="/about" class="hover:text-[#83cb9d]">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/gallery" class="hover:text-[#83cb9d]">
                    Gallery
                  </Link>
                </li>
                <li>
                  <Link href="/founders" class="hover:text-[#83cb9d]">
                    Founders
                  </Link>
                </li>
                <li>
                  <Link href="/contactus" class="hover:text-[#83cb9d]">
                    Contact Us
                  </Link>
                </li>
              </ul>
            ...
            <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
              ...
              <a
                href="https://www.facebook.com/p/Ojas-Uchchtar-Madhymik-Shikshan-Evam-Prashikshan-Sansthan-Morandhana-100063538192628/"
                class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-[#83cb9d] hover:border-[#83cb9d]"
              >
                <svg
              ...
              <a
                href="#"
                class="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-[#83cb9d] hover:border-[#83cb9d]"
              >
                <svg
                  class="w-4 h-4 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="bg-[#104e26] py-4 text-gray-100">
        <div class="container mx-auto px-4">
          <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4  w-full sm:w-auto">
              <p class="text-center">
                © 2024 Ojas Shikshan and Pariksha Sansthan. All Rights Reserved.
              </p>
            </div>
            <div class="px-4 w-full sm:w-auto">
              <ul class="flex justify-center">
                Made with ❤️ by{" "}
                <Link href="https://veilstudio.in" class="hover:text-[#83cb9d]">
                  &nbsp; Veil Studio
                </Link>
              </ul>
            </div>
